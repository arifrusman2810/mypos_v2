<section class="content-header">
  <h1>
    Stock In
    <small>Produk Masuk / Pembelian</small>
  </h1>
  <ol class="breadcrumb">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-center" width="160px">
              ...
              <a href="<?= site_url('stock/in/delete/'.$stock->stock_id. '/' .$stock->item_id); ?>" onclick="return confirm('Yakin mau menghapus?')" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete</a>
            </td>
          </tr>
          <?php endforeach; ?>
        </tbody>
